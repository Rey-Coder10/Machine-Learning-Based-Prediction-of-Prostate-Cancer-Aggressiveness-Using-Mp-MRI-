...
SCENARIO 1: "Dataset kaise process kiya?"
→ Show: Snapshot 01 + 02 (Dataset + Split)

SCENARIO 2: "Feature selection explain karo"
→ Show: Snapshot 03 (LASSO + PCA pipeline)

SCENARIO 3: "Models ka comparison batao"
→ Show: Snapshot 05 + 07 (Results table + ROC curves)

SCENARIO 4: "Confusion matrix dikhaao"
→ Show: Snapshot 06 (All 4 confusion matrices)

SCENARIO 5: "Code dikha sakte ho?"
→ Show: Snapshot 08 (Key code snippets)

SCENARIO 6: "Poora pipeline samjhaao"
→ Show all in sequence: 01 → 02 → 03 → 04 → 05 → 06 → 07
...
Project: Prostate Cancer Aggressiveness Prediction using mp-MRI
